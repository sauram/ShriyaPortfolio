...
const socialMediaHandles = [
    {
        ...
        redirectURL:"https://www.instagram.com/confusedphd"
    },
    {
        handleName:"twitter",
        path:"M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z",
        redirectURL:"https://www.x.com/ShriyaGrover99",
    },
    {
        handleName:"LinkedIn",
        ...
        redirectURL:"https://www.linkedin.com/in/shriya-grover-56846a146/"
    }
]
        ...
        <Flex direction="row" gap="size-300" margin="size-300">
            {
                socialMediaHandles.map(socialMediaHandle => (
                    <Link href={socialMediaHandle.redirectURL} target='_blank' variant='secondary'>
                        <Icon size='M'>
                            <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            viewBox="0 0 448 512">
                                <path d={socialMediaHandle.path}/>
                            </svg>
                        </Icon>
                    </Link>
                ))
